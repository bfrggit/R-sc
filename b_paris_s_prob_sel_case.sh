...
print_usage() {
    echo >&2 "Usage: $0 PROB SELECTOR CASE_LOC PROJ_ROOT OUTPUT_FILE"
}
...
presence_fn=$(realpath "prep_p_paris_v_prob_RData/presence_${NUM_NODES}_${prob}_${case_presence}.RData")
if [ $? -ne 0 ]; then exit $?; fi
