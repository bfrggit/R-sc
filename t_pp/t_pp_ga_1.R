...
#  Author: Charles Zhu
#
# test script for solution/pp_ga_1.R
#
rm(list = ls())
...
opt_list = list(
    ...
    make_option(
        c("--path_planner"),
        action = "store", default = "ga_1", type = "character",
        help = "Path planner name, default = %default"
        ),
    make_option(
        c("--paranoid"),
...
res_status <- "heuristic"
res_value <- ga_fitness
